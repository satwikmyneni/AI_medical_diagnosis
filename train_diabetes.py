...
try:
    dataset_path = os.path.join("datasets", "diabetes.csv")
    ...
    print(f"⚠️ Error: 'diabetes.csv' not found in {dataset_path}!")
    exit()
...
try:
    model_path = os.path.join(models_folder, "diabetes_model.pkl")
...
# 🎉 Done!
print("✅ All done — diabetes prediction pipeline trained and saved!")